...
export default function QuotePage() {
  ...
  return <main className="quote-page">
    <a className="button-primary mobile-sticky-cta" href="#quote-form">Request my estimate <ArrowRight size={15} /></a>
